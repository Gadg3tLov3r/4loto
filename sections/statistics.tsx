export const StatisticsSection = () => {
  return (
    <div className="flex gap-6 flex-wrap">
      <div className="bg-linear-to-r from-[#1F1957] to-[#1F1957] px-3 py-6 md:p-10 rounded-3xl md:rounded-[40px] min-w-full 2xl:min-w-[761px]">
      ...
      {Array.from({ length: 3 }).map((_, index) => (
        <div
          className="bg-[#1F1957] space-y-4 px-6 py-3 text-center rounded-3xl md:rounded-[40px] flex-shrink-0 flex-1 h-[298px]"
          key={index}
        >
          <div>
